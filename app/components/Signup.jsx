...
function Signup() {
  ...
  return (
    <div className="ff-auth-section">
      <div className="ff-auth-container ff-animate-in">
        <div className="ff-card">
          ...
          <form>
              ...
              <div className="ff-input-wrapper">
                ...
                >
                  {showPassword ? (
                    ...
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#86868b" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>
                  )}
                </button>
              </div>
            </div>
            ...
            <div className="ff-checkbox-group">
              <input type="checkbox" className="ff-checkbox" id="terms" />
              <label htmlFor="terms" className="ff-checkbox-label">
